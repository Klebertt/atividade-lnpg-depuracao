...
class Bank:
    ...
    def transfer(self, from_account, to_account, amount):
        if from_account.get_balance() >= amount:  #fix: Verifica se há fundos suficientes
            from_account.withdraw(amount)
            to_account.deposit(amount)
        else:
            print("Insufficient funds for transfer")  #fix: Informa ao usuário que não há fundos suficientes
